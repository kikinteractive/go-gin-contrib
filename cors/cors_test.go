...
func TestAllowCredentials(t *testing.T) {
	...
	if assert.Equal(http.StatusOK, r.Code) {
...
func TestOptionsRequest(t *testing.T) {
	...
	if assert.Equal(http.StatusOK, r.Code) {
		assert.Equal("http://maji.moe", r.Header().Get("Access-Control-Allow-Origin"))
		assert.Equal(strings.Join(defaultAllowMethods, ","), r.Header().Get("Access-Control-Allow-Methods"))
		assert.Equal(strings.Join(defaultAllowHeaders, ","), r.Header().Get("Access-Control-Allow-Headers"))
